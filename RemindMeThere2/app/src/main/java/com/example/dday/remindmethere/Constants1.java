...
public final class Constants1 {
    ...
    public static final String ANDROID_BUILDING_ID = "IICT Building";
    public static final double ANDROID_BUILDING_LATITUDE = 24.918076;
    public static final double ANDROID_BUILDING_LONGITUDE = 91.830793;
